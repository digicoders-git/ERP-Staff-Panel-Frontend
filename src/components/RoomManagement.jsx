...
import { MdHome, MdAdd, MdEdit, MdDelete, MdHotel, MdLayers, MdMeetingRoom, MdSearch, MdInfo } from 'react-icons/md';
...
export default function RoomManagement() {
  ...
  const fetchInitialData = async () => {
    try {
      ...
      toast.error('Residential registry synchronization failure');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-10">
      ...
      <div className="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 overflow-hidden">
        <div className="p-10 border-b border-slate-50 flex flex-col md:flex-row justify-between items-center gap-8 bg-slate-50/30">
          <div>
            <h3 className="text-2xl font-black text-slate-800 tracking-tight">Residential Registry</h3>
          ...
          <div className="relative w-full md:w-96 group">
            ...
            <input
              type="text"
              placeholder="Search Room Manifest..."
              value={searchTerm}
          ...
          <table className="w-full text-center">
            <thead>
              <tr className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] bg-slate-50/50">
                ...
                <th className="px-6 py-6 font-center">Occupancy</th>
              ...
              {filteredRooms.length > 0 ? filteredRooms.map((room) => (
                <tr key={room._id} className="hover:bg-indigo-50/20 transition-all group">
                  <td className="px-10 py-8 text-left">
                    ...
                    <div className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">Institutional Dormitory</div>
                  </td>
                  ...
                  <td className="px-6 py-8">
                    <div className="flex flex-col items-center gap-1">
                      <div className="text-sm font-black text-slate-800 tabular-nums">{room.capacity} Units</div>
